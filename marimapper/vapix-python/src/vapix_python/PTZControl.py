...
class PTZControl:
    ...
    def absolute_move(self, pan: float, tilt: float, zoom: float, speed: float) -> None:
        """
        Moves the camera to the specified position (non-blocking).
        ...
        self.api._send_request_async('com/ptz.cgi', params=params)
        
    def relative_move(self, pan: float, tilt: float, zoom: float, speed: float) -> None:
        """
        Moves the camera by the specified amount (non-blocking).
    ...
    def continuous_move(self, pan_speed: int, tilt_speed: int, zoom_speed: int) -> None:
        """
        Moves the camera continuously in the specified direction (non-blocking).
    ...
    def stop_move(self):
        """
        Stops all movement of the camera (non-blocking).
        """
        self.api._send_request_async('com/ptz.cgi', params={'continuouspantiltmove': '0,0', 'continuouszoommove': '0'})
    ...
    def go_home(self, speed: int):
        """
        Moves the camera to the home position (non-blocking).
    ...
    def set_zoom(self, zoom_level: int) -> bool:
        """
        Sets the zoom to the specified value (non-blocking).
    ...
    def set_autofocus(self, enabled: bool = True):
        """
        Enables or disables autofocus (non-blocking).
